...
import { GithubStarsResponse, StarredItem } from '../../interfaces/github/stars.interface';
import { environment } from '../../../../environments/environment';
import { GithubRepository } from '../../interfaces/github/github.interface';
...
export class GithubService {
  ...
  repoData = signal<GithubRepository | null>(null);
  ...
  async getRepoData(owner = this.defaultOwner, repo = this.defaultRepo) {
    try {
      ...
      this.repoData.set(result.data as GithubRepository);
      this.error.set(null);
    } catch (error) {
